...
private:
  ...
  void flightControlRollPitchZVelYawrateCallback(
    const sensor_msgs::Joy::ConstPtr& pMsg);

  void flightControlPxPyVzYawrateCallback(
    const sensor_msgs::Joy::ConstPtr& pMsg);
...
private:
  ...
  ros::Subscriber flight_control_rollpitch_yawrate_vertvel_sub;
  ros::Subscriber flight_control_xy_yawrate_vertvel_sub;
