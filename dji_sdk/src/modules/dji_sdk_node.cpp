...
DJISDKNode::initFlightControl(ros::NodeHandle& nh)
{
  ...
  flight_control_xy_yawrate_vertvel_sub =
    nh.subscribe<sensor_msgs::Joy>(
      "dji_sdk/flight_control_setpoint_xy_yawrate_zvelocity", 10,
      &DJISDKNode::flightControlPxPyVzYawrateCallback, this);

  flight_control_rollpitch_yawrate_vertvel_sub =
    nh.subscribe<sensor_msgs::Joy>(
      "dji_sdk/flight_control_setpoint_rollpitch_yawrate_zvelocity", 10,
      &DJISDKNode::flightControlRollPitchZVelYawrateCallback, this);
